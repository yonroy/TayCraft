  ...
  return (
    <>
      ...
      <main className="mx-auto w-full max-w-3xl px-5 py-12 flex-1">
        ...
        <div className="mt-6 rounded-2xl border border-line p-5 flex items-center justify-between gap-3">
          <div className="min-w-0 flex-1">
            <div className="font-semibold">Trạng thái</div>
            <Skel className="mt-2 h-[17px] w-[200px] max-w-full" />
          </div>
          <Skel className="h-11 w-[120px] shrink-0 rounded-xl" />
        </div>
        ...
        <div className="mt-3 grid gap-2">
          {[0, 1, 2].map((i) => (
            <div
              key={i}
              className="rounded-xl border border-line px-4 py-3 flex items-center justify-between gap-3"
            >
