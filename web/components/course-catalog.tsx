  ...
  const card = (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        {lesson.isFree && <span className="text-xs font-mono font-bold text-accent-2">FREE</span>}
